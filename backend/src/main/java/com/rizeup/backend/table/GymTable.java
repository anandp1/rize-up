...
public class GymTable {
    ...
    public Gym getGym(int passcode) throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement(
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    return new Gym(resultSet.getInt("passcode"), resultSet.getString("phone"),
                            resultSet.getString("gym_hours"), resultSet.getString("address"),
        ...
        try (PreparedStatement statement = connection.prepareStatement(
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    do {
                        result.add(new Gym(resultSet.getInt("passcode"), resultSet.getString("phone"),
                                resultSet.getString("hours"), resultSet.getString("address"),
                                resultSet.getString("name")));
    ...
    // Add gym info
    public String addGym(int passcode, String phone, String gym_hours, String address, String name)
            throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement(
