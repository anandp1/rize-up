...
public class ClassTable {
    ...
    public ArrayList<Class> getClassScheduleByGym(int gymId) throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement(
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    do{
                        ...
                        result.add(new Class(resultSet.getString("C.name"), resultSet.getInt("C.Sec_no"), resultSet.getString("s.time"), resultSet.getInt("S.day_of_week"), resultSet.getInt("S.Room_number"), resultSet.getString("T.first_name"), resultSet.getString("T.last_name")));
                    }while(resultSet.next());
                    return result;
                }
            }
    ...
    public String addSectionToClass(String cname, String time, String day, int capacity, int room, int Sec) throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement (
    ...
    public String UpdateSection(String cname, String time, String day, int capacity, int room, int Sec) throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement (
    ...
    public String updateClass(String cname, int length, float cost) throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement (
            ...
            if( statement.executeUpdate() >0){
                return "Class updated successful";
            }
        }
        return "Class could not be updated";
    }
